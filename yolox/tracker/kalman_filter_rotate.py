...
class KalmanFilter(object):
    ...
    contains the bounding box center position (x, y), aspect ratio a, height h, angle theta,
    and their respective velocities.

    Object motion follows a constant velocity model. The bounding box location
    (x, y, a, h, theta) is taken as direct observation of the state space (linear
    observation model).

    """

    def __init__(self):
        ndim, dt = 5, 1.  # bb -> obb  4 -> 5
    ...
    def initiate(self, measurement):
        ...
        ----------
        measurement : ndarray
            Bounding box coordinates (x, y, a, h, angle) with center position (x, y),
            aspect ratio a, and height h, angle angle.

        Returns
        -------
        (ndarray, ndarray)
            Returns the mean vector (9 dimensional) and covariance matrix (9x9
